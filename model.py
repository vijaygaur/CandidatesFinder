...
try:
    dictionary = corpora.Dictionary.load('/tmp/cddictionary.dict')
    corpus = corpora.MmCorpus('/tmp/cdcorpus.mm')
    lsi=models.LsiModel(corpus,id2word=dictionary, num_topics=10)
    mapping = pickle.load(open('/tmp/cdmapping.dict','rb'))
except:
    pass
...
class Model:
    def train(self,data):
        ...
        output = open("/tmp/cdmapping.dict","wb")
        ...
        corpora.MmCorpus.serialize('/tmp/cdcorpus.mm',corpus)
        dictionary.save('/tmp/cddictionary.dict')
